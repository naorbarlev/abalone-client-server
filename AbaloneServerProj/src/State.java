...
public class State implements Serializable{
    ...
    //מטריצת תווים המייצגת את לוח המשחק הלוגי
    private char[][] board; 
    //מספר הכדורים שיש לשחקן הנגדי כשהשחקן הנוכחיח רוצה לדחוף אותו
    private int opositePlayerPower, curentPlayerPower;
    //כמות הכדורים שיצאו מהמשחק לכל שחקן
    private int blackPopOut = 0, whitePopOut = 0;
    //קבועים
 ...
 */
    ...
    /**
     * מחזירה האם רצף של מיקומים הוא אלסכון יורד מימין לשמאל
     * @param loc
     * @return 
     */
    ...
    /**
     * מחזירה האם רצף של מיקומים הוא אלכסון יורד משמאל לימין
     * @param loc
     * @return 
     */
    ...
    /**
     * מחזירה האם רצף של מיקומים הוא אלכסון עולה משמאל לימין
     * @param loc
     * @return 
     */
    ...
    /**
     * מחזריה האם רצף של מיוקמים הוא אלכסון עולה מימין לשמאל
     * @param loc
     * @return 
     */
